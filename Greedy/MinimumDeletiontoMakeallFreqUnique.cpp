/**
 * @file MinimumDeletiontoMakeallFreqUnique.cpp
...
int minDeletions(string s)
{
    ...
    // need to initialize the allowed frequency
    int allowedFrequency = v[0];

    // traversing in v and updating the ans and reducing every frequency to its allowed frequencies bcz we need to maintain all frequency unique and in decreasing order
